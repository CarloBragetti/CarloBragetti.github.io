---
title: "Preparazione del motore della mia Aprilia RSV4 1000"
...
mia Aprilia RSV4 - pulizia, misure, **equilibratura delle masse**, verifica dei giochi e rimontaggio
metodico. L'ho documentata passo per passo; qui la ripercorro con un occhio al *perché* di ogni fase.

## STEP 1 - Micropallinatura esterna

Si parte dalla **micropallinatura** dei carter: una micro-sabbiatura delicata che pulisce l'alluminio in
...
Cuore del lavoro di precisione. Con l'**alesametro** si rileva il diametro delle **canne** (controllando
anche conicità e ovalizzazione), col **micrometro** il diametro dei **pistoni**: la differenza dà il
**gioco di accoppiamento pistone-cilindro**. Si imposta poi il **gap (luce al taglio) delle fasce di
...
Si pesa l'**assieme pistone completo** e poi i **singoli componenti**. A seguire, si asporta un po' di
materiale dai **punti non critici** per portare tutte le masse allo stesso valore. Equilibrare le **masse
...
Stessa filosofia per le **bielle**: si misura il **peso complessivo** e, separatamente, il peso del
...
Montaggio delle **fasce** con il corretto **orientamento dei gap**, **accoppiamento pistoni-bielle**, e poi
chiusura del banco per misurare le **tolleranze delle bronzine di banco e di biella** con il **Plastigauge**.
...
Si montano **pistoni e bielle nel monoblocco**, si chiudono le **bronzine di biella e di banco a secco** e
si ri-misura con il **Plastigauge** per un **doppio controllo** delle tolleranze. Poi pulizia finale,
...
A motore chiuso il quadro è chiaro: carter micropallinati, masse alterne e bielle equilibrate, giochi di
banco e biella verificati col Plastigauge, teste lavorate e distribuzione in fase. Più che una riparazione
è stato un lavoro di precisione, con ogni quota misurata e ogni componente pesato prima di richiudere.

Adesso il V4 è di nuovo sulla moto, pronto a girare.
